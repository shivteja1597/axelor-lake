...
try:
    ...
    con.execute("CREATE TABLE iceberg_lake.lake_curated.my_table3 AS SELECT 1 AS a WHERE 1=0;")
    res = con.execute("SELECT * FROM iceberg_lake.lake_curated.my_table3;").fetchall()
    print("DATA:", res)
